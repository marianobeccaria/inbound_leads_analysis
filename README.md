...
The project repository can be initialized locally and synchronized with GitHub using the steps below.
...
Create a new empty repository on GitHub. Do not initialize it with a README, `.gitignore`, or license if those files already exist locally.

### Connect Local Repo to GitHub

Replace `<github-username>` and `<repo-name>` with your actual GitHub username and repository name.
